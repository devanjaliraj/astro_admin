...
export class EditRashiHoroscope extends Component {
  constructor(props) {
    super(props);
    this.state = {
      rashi_title: "",
  ...
  render() {
    return (
      <div>
        <Breadcrumbs
          breadCrumbTitle="Add Rashi Horoscope "
          breadCrumbParent=" home"
          breadCrumbActive="Edit Rashi Horoscope "
        />
        <Card>
          <Row className="m-2">
            <Col>
              ...
              <Route
                render={({ history }) => (
                  <Button
                    ...
                    onClick={() =>
                      history.push("/app/rashihoro/rashiHoroscope")
                    }
                  >
                    Back
                  </Button>
...
export default EditRashiHoroscope;
